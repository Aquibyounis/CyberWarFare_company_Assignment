                    ...
                    {subscriptions.map(({ subscriptionId, course, pricePaid, subscribedAt }) => (
                        <div key={subscriptionId} className="card p-6 flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex-1 space-y-3">
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <div className="flex-shrink-0 text-right">
                                        {pricePaid === 0 ? (
                                            ...
                                            <div>
                                                <span className="text-lg font-bold text-pink-400">${pricePaid.toFixed(2)}</span>
                                ...
                                {/* Action Button */}
                                <div className="pt-2">
                                    <button className="bg-purple-600/20 text-purple-400 hover:bg-purple-600/30 px-4 py-2 rounded-lg transition-colors text-sm font-medium">
                                        Start Learning →
                                    </button>
                                </div>
                            </div>
